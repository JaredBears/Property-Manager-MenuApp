...
CREATE TABLE state(
    ...
    state_name enum('AL', 'AK', 'AZ', 'AR', 'CA', 'CO', 'CT', 'DE', 'DC', 'FL', 'GA', 'HI', 'ID', 'IL', 'IN', 'IA', 'KS', 'KY', 'LA', 'ME', 'MD', 'MA', 'MI', 'MN', 'MS', 'MO', 'MT', 'NE', 'NV', 'NH', 'NJ', 'NM', 'NY', 'NC', 'ND', 'OH', 'OK', 'OR', 'PA', 'RI', 'SC', 'SD', 'TN', 'TX', 'UT', 'VT', 'VA', 'WA', 'WV', 'WI', 'WY') NOT NULL,
...
CREATE TABLE property(
    ...
    yearly_taxes DECIMAL(8, 2) UNSIGNED NOT NULL,
    monthly_mortgage DECIMAL(7, 2) UNSIGNED NOT NULL,
...
CREATE TABLE unit(
    ...
    monthly_rent DECIMAL(7, 2) UNSIGNED NOT NULL,
    PRIMARY KEY (unit_id),
...
CREATE TABLE employee(
    ...
    employee_salary DECIMAL(8, 2) UNSIGNED NOT NULL,
